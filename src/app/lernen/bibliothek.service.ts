...
export class BibliothekService {
  ...
  gibVoegel() : Vokabel[] {
    return [
      ...
      new Vokabel("Gartenbaumläufer","08 Gartenbaumläufer.mp3"),
      new Vokabel("Zaunkönig","09 Zaunkönig.mp3"),
      new Vokabel("Heckenbraunelle","10 Heckenbraunelle.mp3"),
      new Vokabel("Zilpzalp","11 Zilpzalp.mp3"),
      new Vokabel("Fitis","12 Fitis.mp3"),
      new Vokabel("Gelbspötter","13 Gelbspötter.mp3"),
      new Vokabel("Mönchsgrasmücke","14 Mönchsgrasmücke.mp3"),
      new Vokabel("Gartengrasmücke","15 Gartengrasmücke.mp3"),
      new Vokabel("Klappergrasmücke","16 Klappergrasmücke.mp3"),
      new Vokabel("Wintergoldhähnchen","17 Wintergoldhähnchen.mp3"),
      new Vokabel("Sommergoldhähnchen","18 Sommergoldhähnchen.mp3"),
      new Vokabel("Grauschnäpper","19 Grauschnäpper.mp3"),
      new Vokabel("Trauerschnäpper","20 Trauerschnäpper.mp3"),
      new Vokabel("Rotkehlchen","21 Rotkehlchen.mp3"),
      new Vokabel("Hausrotschwanz","22 Hausrotschwanz.mp3"),
      new Vokabel("Gartenrotschwanz","23 Gartenrotschwanz.mp3"),
      new Vokabel("Girlitz","24 Girlitz.mp3"),
      new Vokabel("Mauersegler","25 Mauersegler.mp3"),
      new Vokabel("Rauchschwalbe","26 Rauchschwalbe.mp3"),
      new Vokabel("Mehlschwalbe","27 Mehlschwalbe.mp3"),
      new Vokabel("Bachstelze","28 Bachstelze.mp3"),
      new Vokabel("Nachtigal","29 Nachtigal.mp3"),
      new Vokabel("Star","30 Star.mp3"),
      ...
      new Vokabel("Goldammer","39 Goldammer.mp3"),
      new Vokabel("Amsel","40 Amsel.mp3"),
      new Vokabel("Singdrossel","41 Singdrossel.mp3"),
      new Vokabel("Ringeltaube","42 Ringeltaube.mp3"),
      new Vokabel("Türkentaube","43 Türkentaube.mp3"),
      new Vokabel("Waldohreule","44 Waldohreule.mp3"),
      new Vokabel("Buntspecht","45 Buntspecht.mp3"),
      new Vokabel("Elster","46 Elster.mp3"),
      new Vokabel("Eichelhäher","47 Eichelhäher.mp3"),
      new Vokabel("Rabenkrähe","48 Rabenkrähe.mp3"),
      new Vokabel("Grünspecht","49 Grünspecht.mp3"),
      new Vokabel("Stockente","50 Stockente.mp3"),
   ...
   /*   new Vokabel("Kohlmeise","01 Kohlmeise.m4a"),
      ...
      new Vokabel("Sumpfmeise","03 Sumpfmeise.m4a"),
      ...
      new Vokabel("Tannenmeise","05 Tannenmeise.m4a"),
      new Vokabel("Goldammer","06 Goldammer.m4a"),
      new Vokabel("Haubenmeise","06 Haubenmeise.m4a"),
      new Vokabel("Grauammer","07 Grauammer.m4a"),
      new Vokabel("Schwanzmeise","07 Schwanzmeise.m4a"),
      new Vokabel("Kleiber","08 Kleiber.m4a"),
      new Vokabel("Rohrammer","08 Rohrammer.m4a"),
      new Vokabel("Gartenbaumläufer","09 Gartenbaumläufer.m4a"),
      new Vokabel("Ortolan","09 Ortolan.m4a"),
      new Vokabel("Waldbaumläufer","10 Waldbaumläufer.m4a"),
      new Vokabel("Zaunammer","10 Zaunammer.m4a"),
      new Vokabel("Bachstelze","11 Bachstelze.m4a"),
      new Vokabel("Wintergoldhähnchen","11 Wintergoldhähnchen.m4a"),
      ...
      new Vokabel("Zaunkönig","13 Zaunkönig.m4a"),
      ...
      new Vokabel("Buchfink","16 Buchfink.m4a"),
      new Vokabel("Gimpel","17 Gimpel.m4a"),
      new Vokabel("Schwarzkehlchen","17 Schwarzkehlchen.m4a"),
      new Vokabel("Grünfink","18 Grünfink.m4a"),
      ...
      new Vokabel("Eichelhäher","23 Eichelhäher.m4a"),
      new Vokabel("Jagdfasan","23 Jagdfasan.m4a"),
      new Vokabel("Elster","24 Elster.m4a"),
      new Vokabel("Wachtel","24 Wachtel.m4a"),
      new Vokabel("Aaskrähe","25 Aaskrähe.m4a"),
      new Vokabel("Wachtelkönig","25 Wachtelkönig.m4a"),
      ...
      new Vokabel("Buntspecht","29 Buntspecht.m4a"),
      ...
      new Vokabel("Star","39 Star.m4a"),
      new Vokabel("Birkhuhn","40 Birkhuhn.m4a"),
      new Vokabel("Haussperling","40 Haussperling.m4a"),
      new Vokabel("Auerhuhn","41 Auerhuhn.m4a"),
      new Vokabel("Feldsperling","41 Feldsperling.m4a"),
      new Vokabel("Buchfink","42 Buchfink.m4a"),
      new Vokabel("Haselhuhn","42 Haselhuhn.m4a"),
      new Vokabel("Alpenschneehuhn","43 Alpenschneehuhn.m4a"),
      new Vokabel("Grünfink","43 Grünfink.m4a"),
      new Vokabel("Steinhuhn","44 Steinhuhn.m4a"),
      new Vokabel("Stieglitz","44 Stieglitz.m4a"),
      new Vokabel("Blaukehlchen","45 Blaukehlchen.m4a"),
      new Vokabel("Bluthänfling","45 Bluthänfling.m4a"),
      new Vokabel("Birkenzeisig","46 Birkenzeisig.m4a"),
      new Vokabel("Haubentaucher","46 Haubentaucher.m4a"),
      new Vokabel("Heckenbraunelle","47 Heckenbraunelle.m4a"),
      new Vokabel("Zwergtaucher","47 Zwergtaucher.m4a"),
      new Vokabel("Hausrotschwanz","48 Hausrotschwanz.m4a"),
      new Vokabel("Rohrdommel","48 Rohrdommel.m4a"),
      new Vokabel("Sommergoldhähnchen","49 Sommergoldhähnchen.m4a"),
      new Vokabel("Zwergdommel","49 Zwergdommel.m4a"),
      new Vokabel("Nachtreiher","50 Nachtreiher.m4a"),
      new Vokabel("Türkentaube","50 Türkentaube.m4a"),
      new Vokabel("Graureiher","51 Graureiher.m4a"),
      new Vokabel("Ringeltaube","51 Ringeltaube.m4a"),
      new Vokabel("Graugans","52 Graugans.m4a"),
      new Vokabel("Waldschnepfe","52 Waldschnepfe.m4a"),
      new Vokabel("Mönchsgrasmücke","53 Mönchsgrasmücke.m4a"),
      new Vokabel("Stockente","53 Stockente.m4a"),
      new Vokabel("Gartengrasmücke","54 Gartengrasmücke.m4a"),
      new Vokabel("Krickente","54 Krickente.m4a"),
      new Vokabel("Klappergrasmücke","55 Klappergrasmücke.m4a"),
      new Vokabel("Knäkente","55 Knäkente.m4a"),
      new Vokabel("Dorngrasmücke","56 Dorngrasmücke.m4a"),
      new Vokabel("Pfeifente","56 Pfeifente.m4a"),
      ...
      new Vokabel("Zilpzalp","58 Zilpzalp.m4a"),
      new Vokabel("Fitis","59 Fitis.m4a"),
      new Vokabel("Grosser Brachvogel","59 Grosser Brachvogel.m4a"),
      ...
      new Vokabel("Kranich","62 Kranich.m4a"),
      new Vokabel("Gelbspötter","63 Gelbspötter.m4a"),
      ...
      new Vokabel("Wachtelkönig","69 Wachtelkönig.m4a"),
      new Vokabel("Mariskenrohrsänger","70 Mariskenrohrsänger.m4a"),
      new Vokabel("Singdrossel","70 Singdrossel.m4a"),
      new Vokabel("Feldschwirl","71 Feldschwirl.m4a"),
      new Vokabel("Rotdrossel und Amsel","71 Rotdrossel und Amsel.m4a"),
      new Vokabel("Feldlerche","72 Feldlerche.m4a"),
      ...
      new Vokabel("Gartenrotschwanz","74 Gartenrotschwanz.m4a"),
      new Vokabel("Waldwasserläufer","74 Waldwasserläufer.m4a"),
      new Vokabel("Grünschenkel","75 Grünschenkel.m4a"),
      new Vokabel("Trauerschnäpper","75 Trauerschnäpper.m4a"),
      new Vokabel("Grosser Brachvogel","76 Grosser Brachvogel.m4a"),
      ...
      new Vokabel("Grauschnäpper","78 Grauschnäpper.m4a"),
      new Vokabel("Nachtigal","79 Nachtigal.m4a"),
      new Vokabel("Wachtel","79 Wachtel.m4a"),
      new Vokabel("Graureiher und Stockente","80 Graureiher und Stockente.m4a"),
      new Vokabel("Sprosser","80 Sprosser.m4a"),
      new Vokabel("Baumkieper","81 Baumkieper.m4a"),
      new Vokabel("Pfeifente","81 Pfeifente.m4a"),
      new Vokabel("Girlitz","82 Girlitz.m4a"),
      new Vokabel("Graugans","82 Graugans.m4a"),
      ...
      new Vokabel("Kranich","85 Kranich.m4a"),
      new Vokabel("Rauchschwalbe","85 Rauchschwalbe.m4a"),
      new Vokabel("Mehlschwalbe","86 Mehlschwalbe.m4a"),
      new Vokabel("Mauersegler","87 Mauersegler.m4a"),
